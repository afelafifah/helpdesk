...
class Welcome extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('pengguna/templatedash',$data);
	}
	...
	public function update()
	{
		...
		$arr=$this->db->query("select * from pengguna where username='$userlama'")->row_array();
		$cek=$this->db->query("select * from pengguna where username='$user'")->num_rows();
		if($userlama!=$user){
			if($cek>0){
