...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h5 class="panel-title"><i class="icon-pencil7"></i> Edit Data No Tiket <b><i><?=getnamakk($id);?></i></b></h5>
  </div>
  ...
  <div class="panel-body">
    <div class="form-group">
      ...
      <div class='col-md-9'><input type="text" name="no_tiket" value="<?php echo $getrow['no_tiket'] ;?>" autocomplete="off" required placeholder="Masukkan No Tiket" class="form-control" ></div>
    </div>
    <br>
    <br>
    <div class="form-group">
