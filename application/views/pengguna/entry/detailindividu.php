  ...
  <div class="panel-body">
    <div class="col-md-6">
      <table class="table table-bordered">
          <tr>
              <th width="180">ID_Pegawai</th>
              <td><?php echo $getrow['id_pegawai']; ?></td>
          </tr>
          <tr>
              <th>Nama</th>
    ...
    <div class="col-md-6">
      <table class="table table-bordered">
          ...
          <tr>
           ...
           <tr>
              <th>Kategori</th>
              <td><?php echo getnamaagama($getrow['id_kategori']); ?></td>
          </tr>
           <tr>
              <th>Foto</th>
  ...
  <div class="panel-body">
    <table class="table table-bordered">
      ...
      <tr>
        ...
        <td>
          <?php if(getfile($row->id_jabatan,$id)==""){
              echo '<i>Belum Di Update</i>';
            }else{?>
              <button onclick='open("<?php echo site_url('Welcome/embed/'.getnamafile($row->id_jabatan,$id));?>","displayWindow","width=700,height=600,status=no,toolbar=no,menubar=no,left=355"); ' class="btn btn-md btn-primary" data-popup="tooltip" data-original-title="Lihat File" data-placement="top"><i class="icon-file-eye"></i> Lihat File</button>
           <?php } ?>
        </td>
        <td>
          <center>
            ...
            <a href="<?php echo site_url('entry/hapusfile/'.$id.'/'.$row->id_jabatan.'/'.getnamafile($row->id_jabatan,$id)); ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Ini');" class="btn btn-danger btn-xs tooltips" data-popup="tooltip" data-original-title="Hapus Data" data-placement="top"><i class="icon-x"></i></a>
          </center>
        </td>
      </tr>
    <?php endforeach; ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header bg-primary">
          ...
          <h6 class="modal-title"><strong>Update File <?php echo $ro->jabatan; ?></strong></h6>
        </div>
        <div class="modal-body">
          ...
          <br>
          <input type="hidden" value="<?php echo $id; ?>" name="id_pegawai">
          <input type="hidden" value="<?php echo $ro->id_jabatan; ?>" name="jabatan">
          <input type="hidden" value="<?php echo getnamafile($ro->id_jabatan,$id); ?>" name="gambar_lama">
        </div>
