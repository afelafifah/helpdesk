...
<div class="panel panel-flat">
  <div class="panel-body">
    ...
    <br><br><br>
    <div class="col-md-12">
	  <center><i class="label label-primary"><strong>Berdasarkan Kategori</strong></i></center>
	  <hr>
    ...
    require(
        ...
        function (ec, limitless) {
                ...
                series: [
                    {
                        ...
                        data: [<?php echo $this->db->query("select id_pegawai from pegawai where jk='Laki-laki'")->num_rows(); ?>]
                    },
                    {
                        name: 'Perempuan',
                        type: 'bar',
                        ...
                        data: [<?php echo $this->db->query("select id_pegawai from pegawai where jk='Perempuan'")->num_rows(); ?>]
                    }
                ]
            };
            basic_line_options = {
            ...
            basic_columns_options = {
                ...
                xAxis: [{
                    type: 'category',
                    data: [<?php $no=0; foreach($kategori as $row): $no++;?>'<?php echo $row->kategori; ?>',<?php endforeach;?>]
                }],
                ...
                series: [
                    {
                        name: 'Jumlah',
                        type: 'line',
                        data: [<?php $no=0; foreach($kategori as $row): $no++;?>'<?php echo getjumagama($row->id_kategori); ?>',<?php endforeach;?>],
                        itemStyle: {
                            normal: {
                                label: {
                                    show: true,
