              ...
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h6 class="modal-title"><strong>Ubah NIP dan Password</strong></h6>
                  </div>
                  <div class="modal-body">
                    <div class="form-group">
                      <label class='col-md-3'>NIP</label>
                      <div class='col-md-9'><input type="text" name="username" placeholder="Masukkan NIP" class="form-control" ></div>
                    </div>
                    <br>
                    <?php 
                    $pend=$this->session->userdata('id_pegawai');
                    $qu=$this->db->query("select * from pengguna where id_pegawai='$pend'")->row_array(); ?>
